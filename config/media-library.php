...
use App\Infrastructure\Support\MediaLibrary\PathGenerator;
use App\Infrastructure\Support\MediaLibrary\UrlGenerator;
...
return [
     ...
     */
    'disk_name'                    => env('MEDIA_DISK', env('FILESYSTEM_DRIVER', 'local')),
